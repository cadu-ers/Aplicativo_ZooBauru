...
Aproximar o público do Zoológico Municipal de Bauru

Proporcionar uma experiência informativa sobre animais e ambientes

Facilitar a navegação e localização dentro do zoológico
...
No celular, permita a instalação de “Fontes desconhecidas” caso necessário.
...
Na tela inicial, selecione a área ou animal que deseja conhecer.

Utilize o botão de voltar presente em todas as telas (exceto a inicial) para navegar.
